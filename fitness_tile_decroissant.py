...
with open(fitnessFileName, "w") as fp :
	if fitnessValues["AvgActionTime[ms]"] > 0.9 :
		...
		fp.write( str(fitnessValues["65536"]*t) + " " + str(fitnessValues["32768"]*t) + " " + str(fitnessValues["16384"]*t) + " " + str(fitnessValues["8912"]*t) + " " + str(fitnessValues["4096"]*t) + " " + str(fitnessValues["2048"]*t)+ " " + str(fitnessValues["1024"]*t)+ " " + str(fitnessValues["512"]*t)+" " + str(fitnessValues["128"]*t)+" " + str(fitnessValues["64"]*t)+" " + str(fitnessValues["32"]*t)+" " + str(fitnessValues["16"]*t)+" "+ str(fitnessValues["MeanScore"]*t) )

	else :
		fp.write( str(fitnessValues["65536"]) + " " + str(fitnessValues["32768"]) + " " + str(fitnessValues["16384"]) + " " + str(fitnessValues["8912"]) + " " + str(fitnessValues["4096"]) + " " + str(fitnessValues["2048"])+ " " + str(fitnessValues["1024"])+ " " + str(fitnessValues["512"])+" " + str(fitnessValues["128"])+" " + str(fitnessValues["64"])+" " + str(fitnessValues["32"])+" " + str(fitnessValues["16"])+" "+ str(fitnessValues["MeanScore"]) )
